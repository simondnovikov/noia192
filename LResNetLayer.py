...
#TODO
class ResNetLayer(Layer):  # Relu version
    def __init__(self, num_channels, num_classes):
        Layer.__init__(self, num_channels + 1, num_classes)  # W1 with bias
        self.IN = self.IN - 1
        self.weights.append(np.random.randn(num_channels, num_classes))  # W2 without bias
    ...
    def forward(self, X):
        ...
        return X + self.weights[1].dot(XW)
